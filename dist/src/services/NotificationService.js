...
exports.NotificationChangeType = exports.sendMerchantNotifications = exports.sendNotifications = void 0;
...
const sendMerchantNotifications = (contents, ids, image, deepLink) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield merchant_client.createNotification(notification);
        console.log("response id: " + response.id + "external_id: " + response.external_id);
        if (response.errors &&
            response.errors.invalid_external_user_ids.length > 0) {
            console.log("Error sending notifications due to invalid external ids");
...
exports.sendMerchantNotifications = sendMerchantNotifications;
...
module.exports = {
    ...
    sendMerchantNotifications: exports.sendMerchantNotifications,
};
